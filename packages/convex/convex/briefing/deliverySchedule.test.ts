...
describe('upcomingBriefingDeliverySlots', () => {
  it('creates morning retry slots from 7:45am at their Sydney-local times', () => {
    const slots = upcomingBriefingDeliverySlots({
      nowMs: Date.parse('2026-06-11T21:30:00.000Z'),
    ...
    expect(slots).toEqual([
      ...
      {
        key: 'morning:2026-06-12:morning:07:50',
        localDate: '2026-06-12',
        slot: 'morning',
        scheduledAt: Date.parse('2026-06-11T21:50:00.000Z')
      },
      {
      ...
      {
        key: 'morning:2026-06-12:morning:08:00',
        localDate: '2026-06-12',
        slot: 'morning',
        scheduledAt: Date.parse('2026-06-11T22:00:00.000Z')
      },
      {
      ...
      {
        key: 'morning:2026-06-12:morning:08:10',
        localDate: '2026-06-12',
        slot: 'morning',
        scheduledAt: Date.parse('2026-06-11T22:10:00.000Z')
      }
    ]);
  });
  ...
  it('uses AEDT when calculating a morning slot', () => {
    ...
    expect(slots[0]).toEqual({
      key: 'morning:2026-01-12:morning:07:45',
      localDate: '2026-01-12',
      slot: 'morning',
      scheduledAt: Date.parse('2026-01-11T20:45:00.000Z')
    });
  });
  ...
  it('returns timestamp-sorted slots and excludes slots before now', () => {
    ...
    expect(slots.map((slot) => slot.scheduledAt)).toEqual([
      Date.parse('2026-06-12T21:50:00.000Z'),
      Date.parse('2026-06-12T21:55:00.000Z'),
      Date.parse('2026-06-12T22:00:00.000Z'),
      Date.parse('2026-06-12T22:05:00.000Z'),
      Date.parse('2026-06-12T22:10:00.000Z'),
      Date.parse('2026-06-13T21:45:00.000Z'),
      Date.parse('2026-06-13T21:50:00.000Z')
    ]);
