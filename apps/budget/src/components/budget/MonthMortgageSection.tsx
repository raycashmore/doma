  ...
  return (
    <section className="rounded-3xl bg-warm-section-mortgage p-5 flex-1 min-w-0 flex flex-col gap-3">
      <header className="flex items-center justify-between">
        <h3 className="text-sm font-semibold text-warm-text-primary">Mortgage</h3>
      ...
      <div className="rounded-2xl bg-warm-bg-card p-4">
        <h4 className="text-[11px] uppercase tracking-wide text-warm-text-secondary mb-2">
          Payment split
        </h4>
        <ul className="flex flex-col gap-1.5 text-sm">
          <li className="flex justify-between">
            <span className="text-warm-text-secondary">Interest charged</span>
            <span className="text-warm-text-primary">{formatCurrency(interestCharged)}</span>
          </li>
          <li className="flex justify-between">
            <span className="text-warm-text-secondary">Principal paid</span>
            <span className="text-warm-text-primary">{formatCurrency(principalPaid)}</span>
          </li>
        </ul>
      </div>
      ...
      <div className="rounded-2xl bg-warm-bg-card p-4">
        ...
        <ul className="flex flex-col gap-1.5 text-sm">
          <li className="flex justify-between">
            ...
            <span className="text-warm-text-primary">{formatCurrency(debt1)}</span>
          </li>
          <li className="flex justify-between">
            <span className="text-warm-text-secondary">Debt 2</span>
            <span className="text-warm-text-primary">{formatCurrency(debt2)}</span>
          </li>
          <li className="flex justify-between font-medium">
            <span className="text-warm-text-primary">House equity</span>
            <span className="text-warm-text-primary">{formatCurrency(equity)}</span>
          </li>
        </ul>
      </div>
    </section>
